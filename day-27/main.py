...
# Calls action() when press button
...
# Gets current value in textbox at line 1, char 0
...
# Variable to hold on to checked state, 0
# is off, 1 is on.
check_state = IntVar()
check_button = Checkbutton(text="Is on?",
...
for item in fruits:
    listbox.insert(fruits.index(item),
                   item)
